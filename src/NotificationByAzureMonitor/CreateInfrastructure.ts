...
import { AlertRuleResource, MonitorClient, RuleConditionUnion, ActionGroupResource, AlertRulesCreateOrUpdateOptionalParams, RuleActionUnion, RuleDataSource, ConditionOperator, SmsReceiver } from "@azure/arm-monitor";
...
const resourceGroup: string = "Today2DAY";
const ruleName: string = "ExecutingFunction";
const actionGroupName: string = "Security alert notification";
const groupShortName: string = "alerts";
const smsReceiverName: string = "Hard-coded";
const countryCode: string = "972";
...
const dataResource: RuleDataSource = {
...
const ruleCondition: RuleConditionUnion = {
...
export async function createNewAlertRule(subscription: ISubscriptionContext) {
