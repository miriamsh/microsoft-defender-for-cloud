...
async function selectFiltersCommand(args, type, property) {
    ...
    if (picks) {
        ...
        await (0, configUtils_1.setConfigurationSettings)(constants_1.Constants.extensionPrefix, constants_1.Constants.filtering, subscriptionId, (0, filterSettings_1.setConcreteProperty)(type, property, configurations, newFilters), vscode.ConfigurationTarget.Global);
        args.refresh();
    }
}
